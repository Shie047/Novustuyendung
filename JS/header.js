...
<template id="profile-popup-template">
  ...
  <strong style="margin-left:10px;" >  Chọn Ngôn Ngữ</strong>
          ...
          <button class="profile-menu-item" onclick="window.location.href='dieukhoan.html'"><img src="Img/chinhsach.png" class="setting"  alt="chính sách"><strong> Chính sách</strong></button>
